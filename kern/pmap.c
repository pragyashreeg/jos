...
x64_vm_init(void)
{
	...
	panic("x64_vm_init: this function is not finishedi\n");
...
page_check(void)
{
	struct Page *pp, *pp0, *pp1, *pp2,*pp3,*pp4,*pp5;
	struct Page_list fl;
	pte_t *ptep, *ptep1;
	pdpe_t *pdpe;
	pde_t *pde;
	...
	//cprintf("test=%016lx\n",(((uint64_t *)(((uint64_t *) (boot_pml4e[0]))[0]))[1] );
